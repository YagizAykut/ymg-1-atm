...
public class HesapRepository {
    ...
    // Sahte veritabanımız (Hesap Numarası -> Hesap Objesi)
    private Map<String, Hesap> hesaplar = new HashMap<>();

    // Uygulama başlarken sahte verileri yükle
    @PostConstruct
